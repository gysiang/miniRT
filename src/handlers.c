...
/*   Updated: 2024/10/10 14:57:46 by gyong-si         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*assign_dir(KeySym keysym)
{
	...
	if (keysym == XK_Left)
		...
		d = "down";
	else if (keysym == XK_W || keysym == XK_w || keysym == XK_I || keysym == XK_i)
		d = "forward";
	else if (keysym == XK_S || keysym == XK_s || keysym == XK_K || keysym == XK_k)
		d = "backward";
	else if (keysym == XK_A || keysym == XK_a || keysym == XK_J || keysym == XK_j)
		d = "left";
	else if (keysym == XK_D || keysym == XK_d || keysym == XK_L || keysym == XK_l)
		d = "right";
	else if (keysym == XK_Q || keysym == XK_q || keysym == XK_U || keysym == XK_u)
		d = "up";
	else if (keysym == XK_E || keysym == XK_e || keysym == XK_O || keysym == XK_o)
		d = "down";
	return (d);
}
...
int	handle_light_movement(t_data *data, KeySym keysym)
{
	...
	else if (keysym == XK_U || keysym == XK_u || keysym == XK_O || keysym == XK_o)
		move_camera(&data->light.position, speed, UPDOWN);
	else if (keysym == XK_I || keysym == XK_i || keysym == XK_K || keysym == XK_k)
...
int handle_keypress(KeySym keysym, t_data *data)
{
	...
	else if (keysym == XK_I || keysym == XK_i || keysym == XK_K || keysym == XK_k || keysym == XK_J || keysym == XK_j
		|| keysym == XK_L || keysym == XK_l || keysym == XK_U || keysym == XK_u || keysym == XK_o || keysym == XK_O)
